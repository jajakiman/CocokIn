// Simplified matching engine for Phase 3
...
export function calculateCocokScore(
  ...
  // For Phase 3, we simply use the percentage of matched skills as the full score.
  // The rest of the factors (availability, experience) are hardcoded to the same percentage to pass validation.
