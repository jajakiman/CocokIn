...
export default function TalentDashboardLoading() {
  return (
    <div aria-label="Memuat konten" className="talent-dashboard space-y-10" role="status">
      ...
      <div className="bg-white border border-[#D8E1EE] rounded-2xl p-6 md:p-8">
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 items-stretch">
          <div className="xl:col-span-1 space-y-4 pr-0 xl:pr-4 border-b xl:border-b-0 xl:border-r border-[#D8E1EE] pb-6 xl:pb-0">
